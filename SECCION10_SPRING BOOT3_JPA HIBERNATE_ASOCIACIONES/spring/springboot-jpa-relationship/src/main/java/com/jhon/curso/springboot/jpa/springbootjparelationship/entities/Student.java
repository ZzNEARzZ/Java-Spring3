...
public class Student {
    ...
    @ManyToMany(cascade = {CascadeType.PERSIST, CascadeType.MERGE}) // recordemos que el cascadeType solo se puede utilizar Persist y Merge ya que la relacion es ManuToMany y las otras entidades no pueden desaparecer
