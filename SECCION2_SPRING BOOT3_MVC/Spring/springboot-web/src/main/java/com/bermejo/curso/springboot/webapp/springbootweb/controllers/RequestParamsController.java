...
import com.bermejo.curso.springboot.webapp.springbootweb.models.dto.ParamMixDto;
...
public class RequestParamsController {
    ...
    @GetMapping("/foo")
    public ParamDto foo(@RequestParam(required = false, defaultValue = "Hola que tal Winny") String message) {
